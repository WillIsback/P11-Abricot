	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-4">
				<p className="flex justify-between body-xs text-gray-600">
					Progression{" "}
					<span className="text-gray-800 body-xs">{progression}%</span>
				</p>
			...
			<div className="flex flex-col gap-3.75">
				<div className="flex items-center gap-2">
					...
					<span className="text-gray-600 body-2xs">
						Équipe ({totalTeamMembers})
					</span>
				</div>
