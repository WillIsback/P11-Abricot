...
import { UserSearchQuerySchema, UpdatePasswordSchema } from "@/schemas/frontend.schemas";
...
export const userService = {
    ...
    updateProfile: async (token: string,payload: z.infer<typeof UpdateProfilePayloadSchematic>):
    ...
    updatePassword: async (token: string,payload: z.infer<typeof UpdatePasswordSchema>):
