...
export default function DashBoardKanban({ tasks }: PropsType) {
	...
	return (
		<div className="flex flex-col md:flex-row py-6 sm:py-10 gap-4 sm:gap-x-5.5 w-full">
			<section className="flex flex-col px-4 sm:px-6 py-6 sm:py-10 gap-6 sm:gap-10.25 rounded-[10px] bg-white w-full md:w-1/3">
