...
import type { ProjectMember, User } from "@/schemas/backend.schemas";
	...
	return (
		<div className="flex gap-1">
			<div className="flex gap-1.5">
				...
				<p className="rounded-full bg-brand-light text-brand-text body-s flex items-center justify-center px-4 py-1">
					Propriétaire
				</p>
			</div>
			{variant === "Short" ? (
